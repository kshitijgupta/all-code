...
class Hbase_getRowWithColumns_args {
 public:
  ...
  struct __isset {
    __isset() : tableName(false), row(false), columns(false) {}
    bool tableName;
    bool row;
    bool columns;
  } __isset;
...
class Hbase_getRowWithColumnsTs_args {
 public:
  ...
  struct __isset {
    __isset() : tableName(false), row(false), columns(false), timestamp(false) {}
    bool tableName;
    bool row;
    bool columns;
    bool timestamp;
...
class Hbase_scannerOpenWithPrefix_args {
 public:
  ...
  struct __isset {
    __isset() : tableName(false), startAndPrefix(false), columns(false) {}
    bool tableName;
    bool startAndPrefix;
    bool columns;
  } __isset;
