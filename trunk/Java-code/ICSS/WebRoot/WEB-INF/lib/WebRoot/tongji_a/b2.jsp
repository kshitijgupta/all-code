...
//------创建线图------
String titleString="访问人数统计折线图";//图的标题
JFreeChart chart =ChartFactory.createLineChart(titleString,"时间","访问人数",categoryDataset,PlotOrientation.VERTICAL,true,true,false);
