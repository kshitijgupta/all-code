...
//import com.gdschina.ccu.util.UIDGenerator;   
...
public class Receive {       
    ...
    public Receive(MimeMessage mimeMessage) {       
...
//        fileName = UIDGenerator.getUID();   
    ...
    public static void main(String args[]) throws Exception {      
        ...
        props.put("mail.smtp.host", "pop3.163.com");      
        ...
        try {   
               ...
               inbox.fetch(message, profile);   
               int j = message.length - 1;   
               for (int i = 0; i < message.length; i++,j--) {   
                      System.out.println(inbox.getUID(message[i]));          
  
     
            System.out.println("Messages's length: " + message.length);      
            Receive pmm = null;   
            pmm = new Receive((MimeMessage) message[i]);    
  
            System.out.println("Message " + i + " 是新邮件: " + pmm.isNew());   //是否是新邮件   
            System.out.println("第"+i+"封");   
            System.out.println("======================");      
            System.out.println("Message " + i + " 主题: " + setDecodeText(pmm.getSubject()));   //获取主题   
