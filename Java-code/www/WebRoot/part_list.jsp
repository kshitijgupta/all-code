	...
	<body>
		...
		<div align="center">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="2">
				...
				<tr>
					...
					<td height="25" align="left">
						<a
							href="user_file_detail.jsp?FileID=<%=sData[3]%>&Part=<%=sPart%>"
							target="_self"><font color="#0000FF"><%="&nbsp;" + sData[1]%></font>
						</a>
					</td>
					<td height="25" align="center">
						<font color="#FF0000"><%=sData[2]%></font>
					</td>
			...
			<form action="indexPart_list.jsp" method="post" target="_self">
				...
				第
				<font color="#FF0000"><%=showPage%></font>页/共
				<font color=red><%=Page.getPageCount()%></font>页&nbsp;
				<a href="indexPart_list.jsp?showPage=1" target="_self"><font
					color="#0000FF">[首页]</font> </a>&nbsp;
				<%
					//判断"上一页"链接是否要显示
					if (showPage > 1) {
				%>
				<a
					href="indexPart_list.jsp?showPage=<%=showPage - 1%>&Part=<%=sPart%>"
					target="_self"><font color="#0000FF">[上一页]</font> </a>&nbsp;
				<%
					} else
						out.println("[上一页]&nbsp;");
				...
				<a
					href="indexPart_list.jsp?showPage=<%=showPage + 1%>&Part=<%=sPart%>"
					target="_self"><font color="#0000FF">[下一页]</font> </a>&nbsp;
				<%
					} else
						out.println("[下一页]&nbsp;");
				%>
				<a
					href="indexPart_list.jsp?showPage=<%=Page.getPageCount()%>&Part=<%=sPart%>"
					target="_self"><font color="#0000FF">[尾页]</font> </a>&nbsp; 转到
				...
				<a href="index.jsp"><font color=BLUE>返回主页</font> </a>
			</form>
